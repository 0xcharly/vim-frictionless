	...
	function! s:ColorDictParser(color_dict)
		for [group, group_colors] in items(a:color_dict)
			exec 'hi ' . group
				...
				\ . '    term=' . (group_colors[2] == '' ? 'NONE' :       group_colors[2])
...
call s:ColorDictParser({
	...
	\ , 'CursorLineNr'                : [    237,    240,               '',      'ffffff',  '585858',               '']
	\ , 'CursorColumn'                : [    234,    237,               '',      'ffffff',  '3a3a3a',               '']
	\
